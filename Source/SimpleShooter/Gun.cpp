...
void AGun::PullTrigger()
{
	...
	bool bIsHitFound = GetWorld()->LineTraceSingleByChannel(HitResult, Location, End, ECC_GameTraceChannel1, Params);
	if (bIsHitFound)
	{
		...
		ReceivingActor->TakeDamage(Damage, DamageEvent, Controller, this);
